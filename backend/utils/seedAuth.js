...
export const seedAuthDefaults = async () => {
  try {
    ...
    const roleDefinitions = [
      ...
      {
        roleName: 'Rental Manager',
        roleCode: 'rental_manager',
        description: 'Head of Rental Operations. Full administrative control over 3-Year Rental programs, owner rent-back disbursements, tenant agreements, sales allotments, property leases, inspections, and rental financial audits.',
        isSystemRole: true,
        permissions: [
          permMap['dashboard:view'],
          permMap['rentals:view'],
